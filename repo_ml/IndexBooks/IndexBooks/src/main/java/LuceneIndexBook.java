...
public class LuceneIndexBook {
    public static Directory memoryIndex;
    public static StandardAnalyzer standardAnalyzer;
    public static Word2Vec model;

    public LuceneIndexBook(RAMDirectory ramDirectory, StandardAnalyzer analyzer){
        memoryIndex = ramDirectory;
        standardAnalyzer = analyzer;
        File modWord = new File
                ("C:\\Users\\Rabbit\\IdeaProjects\\indexBooks\\allword.bin.gz");
        //model = WordVectorSerializer.readWord2VecModel(modWord);
    }
